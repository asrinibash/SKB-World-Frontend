...
function Contact() {
  return (
    <motion.section id="contact" className="container mx-auto py-12 px-4 md:py-16 md:px-12"
    initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}>
      <div className="space-y-6">
        <div className="space-y-2 animate-fade-in">
          <h2 className="text-3xl font-bold tracking-tighter  sm:text-4xl"><span className='text-accent'>Contact</span> Us</h2>
